...
namespace { 
  ...
  struct AuxData {
    std::shared_ptr<PL::Expression> field0;
  ...
  std::shared_ptr<PL::Expression> reduce_FORMULA_from_FALSE(const std::string&);
  std::shared_ptr<PL::Expression> reduce_FORMULA_from_FORMULA_AND_FORMULA(std::shared_ptr<PL::Expression> _parserArg1, const std::string&, std::shared_ptr<PL::Expression> _parserArg3);
  std::shared_ptr<PL::Expression> reduce_FORMULA_from_FORMULA_IFF_FORMULA(std::shared_ptr<PL::Expression> _parserArg1, const std::string&, std::shared_ptr<PL::Expression> _parserArg3);
  std::shared_ptr<PL::Expression> reduce_FORMULA_from_FORMULA_IMPLIES_FORMULA(std::shared_ptr<PL::Expression> _parserArg1, const std::string&, std::shared_ptr<PL::Expression> _parserArg3);
  std::shared_ptr<PL::Expression> reduce_FORMULA_from_FORMULA_OR_FORMULA(std::shared_ptr<PL::Expression> _parserArg1, const std::string&, std::shared_ptr<PL::Expression> _parserArg3);
  std::shared_ptr<PL::Expression> reduce_FORMULA_from_IDENTIFIER(const std::string& _parserArg1);
  std::shared_ptr<PL::Expression> reduce_FORMULA_from_LPAREN_FORMULA_RPAREN(const std::string&, std::shared_ptr<PL::Expression> _parserArg2, const std::string&);
  std::shared_ptr<PL::Expression> reduce_FORMULA_from_NOT_FORMULA(const std::string&, std::shared_ptr<PL::Expression> _parserArg2);
  std::shared_ptr<PL::Expression> reduce_FORMULA_from_TRUE(const std::string&);
...
},
{
  ...
  std::shared_ptr<PL::Expression> reduce_FORMULA_from_FALSE(const std::string&) {
    std::shared_ptr<PL::Expression> _parserArg0;
    _parserArg0 = make_shared<PL::FalseExpression>();
    return _parserArg0;
  }

  std::shared_ptr<PL::Expression> reduce_FORMULA_from_FORMULA_AND_FORMULA(std::shared_ptr<PL::Expression> _parserArg1, const std::string&, std::shared_ptr<PL::Expression> _parserArg3) {
    std::shared_ptr<PL::Expression> _parserArg0;
    _parserArg0 = make_shared<PL::AndExpression>(_parserArg1, _parserArg3);
    return _parserArg0;
  }

  std::shared_ptr<PL::Expression> reduce_FORMULA_from_FORMULA_IFF_FORMULA(std::shared_ptr<PL::Expression> _parserArg1, const std::string&, std::shared_ptr<PL::Expression> _parserArg3) {
    std::shared_ptr<PL::Expression> _parserArg0;
    _parserArg0 = make_shared<PL::IffExpression>(_parserArg1, _parserArg3);
    return _parserArg0;
  }

  std::shared_ptr<PL::Expression> reduce_FORMULA_from_FORMULA_IMPLIES_FORMULA(std::shared_ptr<PL::Expression> _parserArg1, const std::string&, std::shared_ptr<PL::Expression> _parserArg3) {
    std::shared_ptr<PL::Expression> _parserArg0;
    _parserArg0 = make_shared<PL::ImpliesExpression>(_parserArg1, _parserArg3);
    return _parserArg0;
  }

  std::shared_ptr<PL::Expression> reduce_FORMULA_from_FORMULA_OR_FORMULA(std::shared_ptr<PL::Expression> _parserArg1, const std::string&, std::shared_ptr<PL::Expression> _parserArg3) {
    std::shared_ptr<PL::Expression> _parserArg0;
    _parserArg0 = make_shared<PL::OrExpression>(_parserArg1, _parserArg3);
    return _parserArg0;
  }

  std::shared_ptr<PL::Expression> reduce_FORMULA_from_IDENTIFIER(const std::string& _parserArg1) {
    std::shared_ptr<PL::Expression> _parserArg0;
    _parserArg0 = make_shared<PL::VariableExpression>(_parserArg1);
    return _parserArg0;
  }
  ...
  std::shared_ptr<PL::Expression> reduce_FORMULA_from_NOT_FORMULA(const std::string&, std::shared_ptr<PL::Expression> _parserArg2) {
    std::shared_ptr<PL::Expression> _parserArg0;
    _parserArg0 = make_shared<PL::NotExpression>(_parserArg2);
    return _parserArg0;
  }

  std::shared_ptr<PL::Expression> reduce_FORMULA_from_TRUE(const std::string&) {
    std::shared_ptr<PL::Expression> _parserArg0;
    _parserArg0 = make_shared<PL::TrueExpression>();
    return _parserArg0;
  }
...
std::shared_ptr<PL::Expression> parsePL(queue<Token>& q) {
